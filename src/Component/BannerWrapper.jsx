...
import herorightfullimg from '../assets/herorightfullimg.png';
import heroheartrotate from '../assets/heroheartrotate.png';
import herobounceimg from '../assets/herobounceimg.png'
import heroauthorimg from '../assets/heroauthorimg.png'
                    ...
                    <Row className=" align-items-center">
                        <Col md={6}>
                            <div className='banner-left-body-content'>
                                ...
                                <h2 className='mb-2 mb-md-4'>Protect Your <span class="wood-animation">Health</span> and Love Be Happy</h2>
                                <p>
                        ...
                        <Col md={6}>
                            <div className='banner-right-body-content'>
                                ...
                                <div class="hero-heart-rotate">
                                    <img decoding="async" src={heroheartrotate} alt="" />
                                </div>
                                <div class="hero-left-bounceimg">
